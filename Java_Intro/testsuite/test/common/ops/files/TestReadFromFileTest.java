...
class TestReadFromFileTest {
	...
	{
		ReadFromFile readFromFile = new ReadFromFile("testsuite/test/common/ops/files", "testRead.txt");
	...
	void testReadFileStringCharset() throws IOException {
		...
		LinkedList<String> lines1 = ReadFromFile.readFile("testsuite/test/common/ops/files/testRead.txt", Charset.defaultCharset());
